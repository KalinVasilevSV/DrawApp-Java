...
//    public Vector<draw.Model.Shape> zList = new Vector<draw.Model.Shape>();
    ...
    public void Draw(Graphics grfx) {
        ...
        for (int i = shapeList.size()-1; i >= 0; i--) {
            DrawShapeSelectionBox(grfx, shapeList.get(i));
        }
    }
    ...
    public void DrawShapeSelectionBox(Graphics g, draw.Model.Shape item) {
    	item.DrawSelectionBox(g);
    }
